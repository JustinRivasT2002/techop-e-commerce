...
import {
  ...
  ɵlazySDKProxy,
  ɵzoneWrap
} from "./chunk-FB3UGJEX.js";
import "./chunk-JNPXGPWK.js";
import {
  firebase
} from "./chunk-5HDPYDED.js";
import {
  isPlatformServer
} from "./chunk-7HDDSE2D.js";
import {
  EnvironmentInjector,
  Inject,
  Injectable,
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-2KZA54ME.js";
import "./chunk-EXOCFMEZ.js";
import {
  Component,
  Deferred,
  ErrorFactory,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-ZDFNFHEM.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
